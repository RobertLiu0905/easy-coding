...
export class CompletionProviderStats {
    ...
    stats() {
        ...
        return {
            completion: Object.assign({ count_auto: this.autoCompletionCount, count_manual: this.manualCompletionCount, cache_hit: this.cacheHitCount, cache_miss: this.cacheMissCount }, eventCount),
            completion_request: {
